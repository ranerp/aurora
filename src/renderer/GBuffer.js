...
AURORA.GBuffer.prototype = {
    ...
    initFrameBufferObject: function() {
        ...
        AURORA.GL.framebufferTexture2D( AURORA.GL.FRAMEBUFFER, buffers[0],  AURORA.GL.TEXTURE_2D, this.textures[AURORA.GBUFFER_TEXTURE_TYPE.GBUFFER_TEXTURE_TYPE_NORMAL], 0);
        AURORA.GL.framebufferTexture2D( AURORA.GL.FRAMEBUFFER, buffers[1],  AURORA.GL.TEXTURE_2D, this.textures[AURORA.GBUFFER_TEXTURE_TYPE.GBUFFER_TEXTURE_TYPE_DEPTHRGB], 0);
    ...
    bindFBOForWriting: function() {
        ...
        AURORA.GL.bindFramebuffer(AURORA.GL.FRAMEBUFFER, this.FBO);
        AURORA.GL.clear(AURORA.GL.DEPTH_BUFFER_BIT);
